      ...
      <div className="relative flex-1">
        ...
        >
          ...
          >
            ...
            <div className="text-[15px] uppercase font-bold">Выбрать часы</div>
          </div>
        ...
        <Menu.Items
          className='dropdown-menu shadow-lg absolute -top-72 xl:top-[90px]
                   ...
                   text-sm w-full bg-white max-w-[332px] py-0
                   rounded-[10px]'
        >
          {
            hours.map((hour, index) => (<div
              onClick={() => setHour(hour)}
              key={index}
              className='uppercasetext-[13px] cursor-pointer py-4 
